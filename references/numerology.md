...
> Chaldean has **no 9** for letters (9 is sacred). Ignore spaces/punctuation. Sum all letters → that is the **compound number**; reduce to a single digit → the **root**. Keep both: the root gives the planetary ruler, the compound carries finer meaning.

## Number ↔ planet

| Number | Planet | Energy (brand lens) |
|---|---|---|
...
- **Moolank (psychic/birth number):** reduce the **day** of birth to one digit. (e.g. born on the 23rd → 2+3 = **5**.)
- **Bhagyank (destiny number):** reduce the **full DD-MM-YYYY** to one digit. This is the dominant lifetime number.
- The brand name ideally resonates with the **Bhagyank** first, **Moolank** second.

## Friend / neutral / enemy numbers

Based on planetary friendships. A name number that is the person's number or a **friend** of it is auspicious; an **enemy** number creates friction.

| Number | Friends | Neutral | Enemies |
|---|---|---|---|
| 1 (Sun) | 1, 2, 3, 9 | 5 | 6, 7, 8 |
...
| Sector | Lean toward |
|---|---|
| Beauty, fashion, jewellery, luxury, hospitality | 6 (Venus), 3 (Jupiter) |
| Trade, retail, communication, agencies, tech-commerce | 5 (Mercury) |
| Finance, education, advisory, law | 3 (Jupiter) |
| Wellness, research, spiritual, niche craft | 7 (Ketu), 6 (Venus) |
| Energy, sport, real estate, food | 9 (Mars), 1 (Sun) |
| Leadership/flagship personal brand | 1 (Sun) |

## Name-tuning procedure

1. Compute the working name's compound + root.
...
8 1 6
```
- **Repeated digits** = pronounced traits; **missing digits** = areas to develop (remedy by featuring that number's planet/colour).
- Rows/diagonals present = "arrows of strength"; absent = "arrows of weakness."
- Use for a personal read ("what am I strong/weak in") and to pick a personal lucky number.
